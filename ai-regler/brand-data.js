...
const BRAND = {
  ...
  documentStyle: {
    ...
    confidential: 'Bruk navy (#0A1628) eller blå (#0077C8) for konfidensielt-merking — aldri rød, aldri kursiv alene',
    headerRule: 'Topptekst inneholder KUN BlueTec-logoen — aldri selskapsnavn, adresse eller telefon i toppteksten. Selskapsinformasjon hører til i bunnteksten.',
    pricingSection: 'Prisseksjoner: H2-overskrift (BlueTec Geometric Bold, navy #0A1628) med blå aksentlinje (#0077C8) under. Priser høyrejustert i to-kolonne layout eller tabell. Aldri understreking eller kursiv for seksjonsoverskrifter.',
    tilbud: {
      label: 'Pristilbud / Tilbud',
      coverPage: 'Navy (#0A1628) bakgrunn · hvit logo øverst til venstre (eller sentrert) · hvit H1-tittel · konfidensielt-merking i hvit tekst (aldri kursiv alene) · evt. prosjektfoto',
      contentPages: 'Hvit (#FFFFFF) bakgrunn · BlueTec-logo øverst til venstre i topptekst · KUN logo i topptekst, ingen selskapstekst · bunntekst på alle sider',
      structure: [
        'Forside (navy #0A1628 bakgrunn)',
        'Mottaker og prosjektinfo',
        'Prisoversikt (H2 med blå aksentlinje, priser høyrejustert)',
        'Produktbeskrivelse og spesifikasjoner',
        'Leveringsbetingelser',
        'Kontaktperson og signatur',
      ],
      never: [
        'Selskapstekst i toppteksten — topptekst er KUN for logo',
        'Hvit bakgrunn på forsiden — alltid navy (#0A1628)',
        'Logo til høyre — alltid til venstre',
        'Kursiv som eneste styling for konfidensielt-merking',
        'Understreking i stedet for H2-hierarki for prisseksjoner',
        'Calibri, Arial eller annen ikke-merkevarefont',
      ],
    },
    neverInDocs: [
